    ...
    <div className="mt-16">
      ...
      <form className="create" onSubmit={createNewPost} >
        <div className="border-b border-gray-900/10">
          <h1 className="text-base font-semibold leading-7 text-gray-900">Create New Post</h1>

          <div>
            <label for="title" class="block text-sm font-medium leading-6 text-gray-900">Input Post Title</label>
          ...
          <div className="mt-5">
            <label for="title" class="block text-sm font-medium leading-6 text-gray-900">Input Post Summary</label>
            <div className="mt-2 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
        ...
        <div className="flex items-center justify-end w-full">
          <button className="post loginbtn px-5 py-3 text-gray-50">Create Post</button>
        </div>
      </form>
    </div>
  );
